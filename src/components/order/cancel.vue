...
export default {
  ...
  data () {
    return {
        ...
        choicestr:[],
        res:"",
        choiceArr:['下错单','临时有事','不想玩了','无人接单','沟通后取消','其他原因',]
    }
  },
  updated(){
    ...
    routerGo(){
      ...
      sublimts(){
          ...
          this.alertFn('请选择或请填写取消原因');
      		...
      		this.$http.post("/h5/esport-api/v1/order/cancel_order",{'user_token':tokens,"order_no":order_no,"type":1,"tag_list":choicestr,"content":this.textarea},{emulateJSON: true}).then(
              (response)=>{
